...
#   When the Python interpreter RUNS a program, it ignores everything
#   from a   #   (hash) mark to the end of the line with the   #   mark.
#
...
#
#   You have now completed _TODO_ #2, so change its _TODO_ on line 35
#   to DONE (and likewise for all forthcoming TODOs in this course).
#
########################################################################
...
#   as you did when you ran this module the first time, or by pressing
#   the green rightward-pointing triangle that is the "Play" button
#   on the toolbar at the top of this window.  Look at the Run window
#   to be sure that your string printed as expected.
#
########################################################################
...
#
# TODO: 4.
#   Add yet another   print   statement below the previous one.
...
#   for this TO-DO?  (HINT: It is an INTERESTING number.)
#   Get help if your value is wrong.
#
########################################################################
...
#
#   The BLUE font color means that you have made changes to this file
#   which have not yet been COMMITTED to version control and PUSHED
#   to the cloud.
#
...
#        (If you see only a Commit button:
...
#   is backed-up in the cloud, and also so that your instructor can
#   access it as needed.  If you COMMIT but forget to PUSH, you can
#   subsequently do the PUSH by:
#      VCS ~ Git ~ Push...
#
#   Oh, one more thing:
